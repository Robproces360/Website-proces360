...
export const metadata: Metadata = {
  ...
  description: 'Leer hoe u de terugverdientijd van een cobot berekent. Ontdek wanneer robotisering rendabel is voor uw MKB-maakbedrijf. Inclusief ROI-formule en rekenvoorbeelden.',
  keywords: [
...
const articleSchema = {
  ...
  description: 'Leer hoe u de terugverdientijd van een cobot berekent.',
