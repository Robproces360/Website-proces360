    ...
    <main className="min-h-screen bg-bg-primary pt-24 pb-16">
      ...
      <section className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-8">Vraag een gratis quickscan aan en ontdek waar de grootste verbeterkansen liggen.</p>
          <Link href="/contact?subject=quickscan" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary-500 text-white font-bold rounded-lg hover:bg-primary-600 transition-colors">
            Gratis Quickscan Aanvragen <ArrowRight className="w-5 h-5" />
          </Link>
        </div>
      </section>
    </main>
